...
/* Notes: Using modules is useful for keeping the code organized and able to be maintained. 
Also modules can be referenced infinitely making the module reusable. 
Modules make the code easier to debug. */ 
